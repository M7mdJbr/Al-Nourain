  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h1 className="font-quran mt-25 text-3xl text-center text-emerald-700 dark:text-emerald-400 mb-8 leading-[2.4]">
          سور القرآن الكريم
        </h1>
          ...
          {surahs.map((surah) => (
            ...
            >
              ...
              <div className="text-right flex-1 mr-4">
                <h2 className="font-quran font-semibold text-gray-800 dark:text-gray-200 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors leading-[2.4]">
                  {surah.name}
                </h2>
