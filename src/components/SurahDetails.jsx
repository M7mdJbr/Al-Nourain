        ...
        {!loading && !error && surahData && (
          <>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-emerald-100 dark:border-gray-700 p-8 mb-8 text-center">
              ...
              <h1 className="font-quran text-4xl text-emerald-700 dark:text-emerald-400 mb-3">
                {surahData.name}
              </h1>
              <p className="text-gray-500 dark:text-gray-400 text-lg">
            ...
            {surahData.number !== 9 && (
              <p className="font-quran text-center text-2xl md:text-3xl text-emerald-800 dark:text-emerald-300 mb-10 leading-[2.4]">
              ...
              {surahData.ayahs.map((ayah) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <p className="font-quran flex-1 text-xl md:text-2xl leading-[2.4] text-gray-800 dark:text-gray-200 text-right">
                      {ayah.text}
                    </p>
                  </div>
                </div>
